#include "../../include/phases/MulesPasture.h"
...
MulesPasture::MulesPasture() : Phase(Vector2f(0, 0), 0, nullptr, nullptr) {}

MulesPasture::MulesPasture(Vector2f size, float limiarX, Player *p1, Player *p2)
...
MulesPasture::~MulesPasture() {}

void MulesPasture::execute() {
...
void MulesPasture::createEnemies() {
  createSaci();
  createMulas();
}

void MulesPasture::createMulas() {
...
void MulesPasture::createObstacles() { createSpikes(); }

void MulesPasture::createSpikes() {
